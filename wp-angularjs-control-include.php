...
Description: Include angularjs javascript for a specific post (using custom field angularjs-include)
...
function waci_enqueue_js () {
  global $post;
  $post_angularjs_include_value = get_post_meta($post->ID, 'angularjs-include', true);
